...
namespace App_Gym.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ProfesorsController(App_GymDabataseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,id,nombre,apellido,telefono,mail,habilitado")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpleado,id,nombre,apellido,telefono,mail,habilitado")] Profesor profesor)
        {
            if (id != profesor.id)
            {
                return NotFound();
